    ...
    def run_once(self):
                ...
                if hasattr(self.db, "get_open_positions"):
                    ...
                    def _sf_qty(x, default=0.0):
                        try:
                            ...
                            return float(default)
                    _positions = [pp for pp in _positions if (isinstance(pp, dict) and _sf_qty(pp.get('qty', 0), 0) > 0)]
                    ...
                    def _sf_qty(x, default=0.0):
                        try:
                            ...
                            return float(default)
                    _positions = [pp for pp in _positions if _sf_qty((pp.get('qty', 0) if isinstance(pp, dict) else 0), 0) > 0]
        ...
        def _sf_qty(x, default=0.0):
            try:
                ...
                return float(default)
        positions = [pp for pp in positions if (isinstance(pp, dict) and _sf_qty(pp.get('qty', 0), 0) > 0)]
